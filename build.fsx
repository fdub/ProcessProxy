...
let project = "ProcessProxy"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Prototype of a library to proxy a class that is instantiated and executed in another process"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Prototype of a library to proxy a class that is instantiated and executed in another process"

// List of author names (for NuGet package)
let authors = [ "fdub <fdub@posteo.de>" ]

// Tags for your project (for NuGet package)
let tags = "DynamicProxy Isolation Process"

// File system information
let solutionFile  = "ProcessProxy.sln"
...
let gitOwner = "fdub"
let gitHome = sprintf "%s/%s" "https://github.com/fdub/ProcessProxy" gitOwner

// The name of the project on GitHub
let gitName = "ProcessProxy"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/fdub"
